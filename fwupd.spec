...
Version  : 1.8.8
Release  : 61
URL      : https://github.com/hughsie/fwupd/archive/1.8.8/fwupd-1.8.8.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.8.8/fwupd-1.8.8.tar.gz
...
%prep
%setup -q -n fwupd-1.8.8
cd %{_builddir}/fwupd-1.8.8
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670957283
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/fwupd-1.8.8/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.8.8/libfwupdengine.so
/usr/lib64/fwupd-1.8.8/libfwupdplugin.so
/usr/lib64/fwupd-1.8.8/libfwupdutil.so
