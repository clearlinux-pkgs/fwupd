...
Version  : 1.9.11
Release  : 73
URL      : https://github.com/hughsie/fwupd/archive/1.9.11/fwupd-1.9.11.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.9.11/fwupd-1.9.11.tar.gz
...
%prep
%setup -q -n fwupd-1.9.11
cd %{_builddir}/fwupd-1.9.11
%patch -P 1 -p1
pushd ..
cp -a fwupd-1.9.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704294709
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/fwupd-1.9.11/libfu_plugin_modem_manager.so
/V3/usr/lib64/fwupd-1.9.11/libfwupdengine.so
/V3/usr/lib64/fwupd-1.9.11/libfwupdplugin.so
/V3/usr/lib64/fwupd-1.9.11/libfwupdutil.so
/V3/usr/lib64/libfwupd.so.2.0.0
/usr/lib64/fwupd-1.9.11/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.9.11/libfwupdengine.so
/usr/lib64/fwupd-1.9.11/libfwupdplugin.so
/usr/lib64/fwupd-1.9.11/libfwupdutil.so
