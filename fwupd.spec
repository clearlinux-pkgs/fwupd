...
Source0  : https://github.com/fwupd/fwupd/releases/download/1.9.22/fwupd-1.9.22.tar.xz
Source1  : fwupd.tmpfiles
Source2  : https://github.com/fwupd/fwupd/releases/download/1.9.22/fwupd-1.9.22.tar.xz.asc
...
%setup -q -n fwupd-1.9.22
cd %{_builddir}/fwupd-1.9.22
%patch -P 1 -p1
pushd ..
cp -a fwupd-1.9.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722284980
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/fwupd-1.9.22/libfu_plugin_modem_manager.so
/V3/usr/lib64/fwupd-1.9.22/libfwupdengine.so
/V3/usr/lib64/fwupd-1.9.22/libfwupdplugin.so
/V3/usr/lib64/fwupd-1.9.22/libfwupdutil.so
/V3/usr/lib64/libfwupd.so.2.0.0
/usr/lib64/fwupd-1.9.22/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.9.22/libfwupdengine.so
/usr/lib64/fwupd-1.9.22/libfwupdplugin.so
/usr/lib64/fwupd-1.9.22/libfwupdutil.so
