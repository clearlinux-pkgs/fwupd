...
Version  : 1.8.10
Release  : 63
URL      : https://github.com/hughsie/fwupd/archive/1.8.10/fwupd-1.8.10.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.8.10/fwupd-1.8.10.tar.gz
...
%prep
%setup -q -n fwupd-1.8.10
cd %{_builddir}/fwupd-1.8.10
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674514228
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/fwupd-1.8.10/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.8.10/libfwupdengine.so
/usr/lib64/fwupd-1.8.10/libfwupdplugin.so
/usr/lib64/fwupd-1.8.10/libfwupdutil.so
