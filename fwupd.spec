...
Source0  : https://github.com/hughsie/fwupd/archive/1.3.2/fwupd-1.3.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571695537
...
cp %{_builddir}/fwupd-1.3.2/COPYING %{buildroot}/usr/share/package-licenses/fwupd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/fwupd-1.3.2/contrib/debian/signing-template/copyright %{buildroot}/usr/share/package-licenses/fwupd/c1a12b921301c21ba9b3dc26e7db1d859bb8259d
cp %{_builddir}/fwupd-1.3.2/data/tests/thunderbolt/COPYING %{buildroot}/usr/share/package-licenses/fwupd/c10b5d1532bdbc2ceae3a33e7ecc8ecbb7f7d260
