...
Version  : 1.9.10
Release  : 72
URL      : https://github.com/hughsie/fwupd/archive/1.9.10/fwupd-1.9.10.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.9.10/fwupd-1.9.10.tar.gz
...
%prep
%setup -q -n fwupd-1.9.10
cd %{_builddir}/fwupd-1.9.10
%patch -P 1 -p1
pushd ..
cp -a fwupd-1.9.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701973061
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/fwupd-1.9.10/libfu_plugin_modem_manager.so
/V3/usr/lib64/fwupd-1.9.10/libfwupdengine.so
/V3/usr/lib64/fwupd-1.9.10/libfwupdplugin.so
/V3/usr/lib64/fwupd-1.9.10/libfwupdutil.so
/V3/usr/lib64/libfwupd.so.2.0.0
/usr/lib64/fwupd-1.9.10/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.9.10/libfwupdengine.so
/usr/lib64/fwupd-1.9.10/libfwupdplugin.so
/usr/lib64/fwupd-1.9.10/libfwupdutil.so
