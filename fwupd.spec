...
Version  : 1.8.4
Release  : 58
URL      : https://github.com/hughsie/fwupd/archive/1.8.4/fwupd-1.8.4.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.8.4/fwupd-1.8.4.tar.gz
...
%prep
%setup -q -n fwupd-1.8.4
cd %{_builddir}/fwupd-1.8.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663684641
