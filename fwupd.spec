...
Version  : 1.8.0
Release  : 56
URL      : https://github.com/hughsie/fwupd/archive/1.8.0/fwupd-1.8.0.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.8.0/fwupd-1.8.0.tar.gz
...
%prep
%setup -q -n fwupd-1.8.0
cd %{_builddir}/fwupd-1.8.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651588022
...
cp %{_builddir}/fwupd-1.8.0/COPYING %{buildroot}/usr/share/package-licenses/fwupd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/fwupd-1.8.0/plugins/thunderbolt/tests/COPYING %{buildroot}/usr/share/package-licenses/fwupd/c10b5d1532bdbc2ceae3a33e7ecc8ecbb7f7d260
