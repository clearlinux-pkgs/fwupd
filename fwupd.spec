...
%prep
%setup -q -n fwupd-1.9.21
cd %{_builddir}/fwupd-1.9.21
%patch -P 1 -p1
pushd ..
cp -a fwupd-1.9.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718310063
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/fwupd-1.9.21/libfu_plugin_modem_manager.so
/V3/usr/lib64/fwupd-1.9.21/libfwupdengine.so
/V3/usr/lib64/fwupd-1.9.21/libfwupdplugin.so
/V3/usr/lib64/fwupd-1.9.21/libfwupdutil.so
/V3/usr/lib64/libfwupd.so.2.0.0
/usr/lib64/fwupd-1.9.21/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.9.21/libfwupdengine.so
/usr/lib64/fwupd-1.9.21/libfwupdplugin.so
/usr/lib64/fwupd-1.9.21/libfwupdutil.so
