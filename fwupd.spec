...
%prep
%setup -q -n fwupd-1.7.3
cd %{_builddir}/fwupd-1.7.3
%patch1 -p1
...
cp %{_builddir}/fwupd-1.7.3/COPYING %{buildroot}/usr/share/package-licenses/fwupd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/fwupd-1.7.3/plugins/thunderbolt/tests/COPYING %{buildroot}/usr/share/package-licenses/fwupd/c10b5d1532bdbc2ceae3a33e7ecc8ecbb7f7d260
