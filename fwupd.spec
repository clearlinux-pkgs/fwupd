...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573585405
...
cp %{_builddir}/fwupd-1.3.3/COPYING %{buildroot}/usr/share/package-licenses/fwupd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/fwupd-1.3.3/contrib/debian/signing-template/copyright %{buildroot}/usr/share/package-licenses/fwupd/c1a12b921301c21ba9b3dc26e7db1d859bb8259d
