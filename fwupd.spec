...
Version  : 1.9.8
Release  : 70
URL      : https://github.com/hughsie/fwupd/archive/1.9.8/fwupd-1.9.8.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.9.8/fwupd-1.9.8.tar.gz
...
%prep
%setup -q -n fwupd-1.9.8
cd %{_builddir}/fwupd-1.9.8
%patch -P 1 -p1
pushd ..
cp -a fwupd-1.9.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700170048
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/fwupd-1.9.8/libfu_plugin_modem_manager.so
/V3/usr/lib64/fwupd-1.9.8/libfwupdengine.so
/V3/usr/lib64/fwupd-1.9.8/libfwupdplugin.so
/V3/usr/lib64/fwupd-1.9.8/libfwupdutil.so
/V3/usr/lib64/libfwupd.so.2.0.0
/usr/lib64/fwupd-1.9.8/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.9.8/libfwupdengine.so
/usr/lib64/fwupd-1.9.8/libfwupdplugin.so
/usr/lib64/fwupd-1.9.8/libfwupdutil.so
