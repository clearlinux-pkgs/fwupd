...
Source0  : https://github.com/hughsie/fwupd/archive/1.8.9/fwupd-1.8.9.tar.gz
...
%prep
%setup -q -n fwupd-1.8.9
cd %{_builddir}/fwupd-1.8.9
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672762169
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/fwupd-1.8.9/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.8.9/libfwupdengine.so
/usr/lib64/fwupd-1.8.9/libfwupdplugin.so
/usr/lib64/fwupd-1.8.9/libfwupdutil.so
