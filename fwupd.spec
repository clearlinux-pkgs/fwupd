...
Version  : 1.7.2
Release  : 50
URL      : https://github.com/hughsie/fwupd/archive/1.7.2/fwupd-1.7.2.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.7.2/fwupd-1.7.2.tar.gz
...
%prep
%setup -q -n fwupd-1.7.2
cd %{_builddir}/fwupd-1.7.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639156666
...
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Ddocs=none  builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/package-licenses/fwupd
cp %{_builddir}/fwupd-1.7.2/COPYING %{buildroot}/usr/share/package-licenses/fwupd/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/fwupd-1.7.2/plugins/thunderbolt/tests/COPYING %{buildroot}/usr/share/package-licenses/fwupd/c10b5d1532bdbc2ceae3a33e7ecc8ecbb7f7d260
...
/usr/share/fwupd/device-tests/broadcom-bcm5719.json
...
/usr/share/fwupd/device-tests/lenovo-03x7609-ccgx.json
/usr/share/fwupd/device-tests/lenovo-03x7609-cxaudio.json
/usr/share/fwupd/device-tests/lenovo-03x7609-vli.json
...
/usr/share/fwupd/device-tests/starlabs-phison-ata.json
...
/usr/share/fwupd/quirks.d/vli-pd.quirk
/usr/share/fwupd/quirks.d/vli-usbhub-bizlink.quirk
/usr/share/fwupd/quirks.d/vli-usbhub-hyper.quirk
/usr/share/fwupd/quirks.d/vli-usbhub-lenovo.quirk
/usr/share/fwupd/quirks.d/vli-usbhub-minibons.quirk
...
/usr/lib64/fwupd-plugins-5/libfu_plugin_cfu.so
...
/usr/lib64/fwupd-plugins-5/libfu_plugin_tpm.so
