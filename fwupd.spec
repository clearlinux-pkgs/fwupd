...
%prep
%setup -q -n fwupd-1.9.15
cd %{_builddir}/fwupd-1.9.15
%patch -P 1 -p1
pushd ..
cp -a fwupd-1.9.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710180158
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/fwupd-1.9.15/libfu_plugin_modem_manager.so
/V3/usr/lib64/fwupd-1.9.15/libfwupdengine.so
/V3/usr/lib64/fwupd-1.9.15/libfwupdplugin.so
/V3/usr/lib64/fwupd-1.9.15/libfwupdutil.so
/V3/usr/lib64/libfwupd.so.2.0.0
/usr/lib64/fwupd-1.9.15/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.9.15/libfwupdengine.so
/usr/lib64/fwupd-1.9.15/libfwupdplugin.so
/usr/lib64/fwupd-1.9.15/libfwupdutil.so
