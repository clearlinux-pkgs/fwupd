...
Version  : 1.9.12
Release  : 74
URL      : https://github.com/hughsie/fwupd/archive/1.9.12/fwupd-1.9.12.tar.gz
Source0  : https://github.com/hughsie/fwupd/archive/1.9.12/fwupd-1.9.12.tar.gz
...
%prep
%setup -q -n fwupd-1.9.12
cd %{_builddir}/fwupd-1.9.12
%patch -P 1 -p1
pushd ..
cp -a fwupd-1.9.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706109744
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/fwupd-1.9.12/libfu_plugin_modem_manager.so
/V3/usr/lib64/fwupd-1.9.12/libfwupdengine.so
/V3/usr/lib64/fwupd-1.9.12/libfwupdplugin.so
/V3/usr/lib64/fwupd-1.9.12/libfwupdutil.so
/V3/usr/lib64/libfwupd.so.2.0.0
/usr/lib64/fwupd-1.9.12/libfu_plugin_modem_manager.so
/usr/lib64/fwupd-1.9.12/libfwupdengine.so
/usr/lib64/fwupd-1.9.12/libfwupdplugin.so
/usr/lib64/fwupd-1.9.12/libfwupdutil.so
